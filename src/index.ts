...
const PRICE_TO_PRODUCT: Record<string, { name: string; slug: string; isLifetime?: boolean }> = {
  ...
  'price_screenshot_pro_lifetime': { name: 'screenshot API Pro', slug: 'screenshot_api', isLifetime: true },
  // === SUB.ALERTS ===
  'price_sub_alerts_pro': { name: 'sub.alerts Pro', slug: 'sub_alerts' },
  'price_sub_alerts_pro_lifetime': { name: 'sub.alerts Pro', slug: 'sub_alerts', isLifetime: true },
  // === LEAK.SCAN ===
  'price_leak_scan_pro': { name: 'leak.scan Pro', slug: 'leak_scan' },
  'price_leak_scan_pro_lifetime': { name: 'leak.scan Pro', slug: 'leak_scan', isLifetime: true },
  // === DOMAIN EXPIRY ===
  'price_domain_expiry_pro': { name: 'domain-expiry Pro', slug: 'domain_expiry' },
  'price_domain_expiry_pro_lifetime': { name: 'domain-expiry Pro', slug: 'domain_expiry', isLifetime: true },
  // === DATA ENRICHMENT ===
  'price_data_enrichment_pro': { name: 'data-enrichment API Pro', slug: 'data_enrichment' },
  'price_data_enrichment_pro_lifetime': { name: 'data-enrichment API Pro', slug: 'data_enrichment', isLifetime: true },
  // === BUNDLE ===
  'price_bundle': { name: 'EdgeIQ All-Access Bundle', slug: 'bundle' },
  'price_bundle_lifetime': { name: 'EdgeIQ All-Access Bundle', slug: 'bundle', isLifetime: true },
};
